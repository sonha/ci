...
<body>
    ...
    <section id="about-us" class="container main">
        <div class="row-fluid">
            <div class="span8">
                <div class="blog">
                    <?php foreach($all_new as $key => $new) { ?>
                    <div class="blog-item well">
                        <a href="#"><h2><?php echo $new->title;?></h2></a>
                        <div class="blog-meta clearfix">
                            <p class="pull-left">
                              <i class="icon-user"></i> by <a href="#"><?php echo $new->author;?></a> | <i class="icon-folder-close"></i> Category <a href="#"><?php echo $new->category_id;?></a> | <i class="icon-calendar"></i>
                               <?php echo ($new->create_at) ? $new->create_at : '2015 June 15';?>
                          </p>
                      ...
                      <?php echo $this->News_model->truncate($new->content,200);?>
