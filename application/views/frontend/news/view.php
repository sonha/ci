    ...
    <section id="about-us" class="container">
                ...
                <div class="blog">
                    <div class="blog-item well">
                        ...
                        <div class="blog-meta clearfix">
                            <p class="pull-left">
                              <i class="icon-user"></i> by <a href="#"><?php echo $news->author;?></a> | <i class="icon-folder-close"></i> Category <a href="#"><?php echo $news->category_id;?></a> | <i class="icon-calendar"></i> Sept 16th, 2012 | <i class="icon-calendar"><?php echo $news->hits;?></i>
                          </p>
                          <p class="pull-right"><i class="icon-comment pull"></i> <a href="#comments">3 Comments</a></p>
                      </div>
                      <p><img src="<?php echo base_url();?>assets/nova/images/sample/blog1.jpg" width="100%" alt="" /></p>
                    ...
                    <div class="user-info media box">
                        <div class="pull-left">
                            <img src="<?php echo base_url();?>assets/nova/images/sample/avatar.jpg" alt="" />
                        </div>
                        <div class="media-body">
                            <h5 style="margin-top: 0"><?php echo $news->author;?></h5>
                    ...
                    <div id="comments" class="comments">
                        ...
                        <div class="comments-list">
                            <div class="comment media">
                                <div class="pull-left">
                                    <img class="avatar" src="<?php echo base_url();?>assets/nova/images/sample/cAvatar1.jpg" alt="" />  
                                </div>
                            ...
                            <div class="comment media">
                                <div class="pull-left">
                                    <img class="avatar" src="<?php echo base_url();?>assets/nova/images/sample/cAvatar2.jpg" alt="" />     
                                </div>
        ...
        <aside class="span4">
            ...
            <div class="widget ads">
                <div class="row-fluid">
                    <div class="span6">
                        <a href="#"><img src="<?php echo base_url();?>assets/nova/images/ads/ad1.png" alt=""></a>
                    </div>

                    <div class="span6">
                        <a href="#"><img src="<?php echo base_url();?>assets/nova/images/ads/ad2.png" alt=""></a>
                    </div>
                </div>
                <p> </p>
                <div class="row-fluid">
                    <div class="span6">
                        <a href="#"><img src="<?php echo base_url();?>assets/nova/images/ads/ad3.png" alt=""></a>
                    </div>

                    <div class="span6">
                        <a href="#"><img src="<?php echo base_url();?>assets/nova/images/ads/ad4.png" alt=""></a>
                    </div>
                </div>
            </div>
            <!-- /.ads -->
            ...
            <div class="widget widget-popular">
                ...
                <div class="widget-blog-items">
                    ...
                    <?php foreach($popular as $key => $new) { ?>
                    <div class="widget-blog-item media">
                        ...
                        <div class="media-body">
                            <a href="<?php echo base_url().'home/view/'.$new->id;?>"><h5><?php echo $new->title;?></h5></a>
                        </div>
                    </div>
                    <?php } ?>
                </div>                        
