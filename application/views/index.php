...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url();?>assets/nova/images/ico/favicon.ico">
        ...
        <div class="sl-slider">
            ...
            <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src="<?php echo base_url();?>assets/nova/images/sample/slider/img1.png" alt="" />
            ...
            <div class="sl-slide item2" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src="<?php echo base_url();?>assets/nova/images/sample/slider/img2.png" alt="" />
            ...
            <div class="sl-slide item3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                <div class="sl-slide-inner">
                   <div class="container">
                    <img class="pull-right" src="<?php echo base_url();?>assets/nova/images/sample/slider/img3.png" alt="" />
...
<section id="recent-works">
    <div class="container">
        ...
        <ul class="gallery col-4">
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url();?>assets/nova/images/portfolio/thumb/item1.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-1" class="modal hide fade">
                    ...
                    <div class="modal-body">
                        <img src="<?php echo base_url();?>assets/nova/images/portfolio/full/item1.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 1--> 
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url();?>assets/nova/images/portfolio/thumb/item2.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                        <a data-toggle="modal" href="#modal-1"><i class="icon-eye-open"></i></a><a href="#"><i class="icon-link"></i></a>                                
                ...
                <div id="modal-1" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url();?>assets/nova/images/portfolio/full/item2.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 2-->
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url();?>assets/nova/images/portfolio/thumb/item3.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-3" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url();?>assets/nova/images/portfolio/full/item3.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 3--> 
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url();?>assets/nova/images/portfolio/thumb/item4.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-4" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url();?>assets/nova/images/portfolio/full/item4.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 4-->               
                ...
                <div id="myCarousel" class="carousel slide clients">
                  ...
                  <div class="carousel-inner">
                    <div class="active item">
                        <div class="row-fluid">
                            <ul class="thumbnails">
                                <li class="span3"><a href="#"><img src="<?php echo base_url();?>assets/nova/images/sample/clients/client1.png"></a></li>
                                <li class="span3"><a href="#"><img src="<?php echo base_url();?>assets/nova/images/sample/clients/client2.png"></a></li>
                                <li class="span3"><a href="#"><img src="<?php echo base_url();?>assets/nova/images/sample/clients/client3.png"></a></li>
                                <li class="span3"><a href="#"><img src="<?php echo base_url();?>assets/nova/images/sample/clients/client4.png"></a></li>
                            </ul>
                        </div>
                    </div>
